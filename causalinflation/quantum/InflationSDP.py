    ...
    def _discover_inflation_symmetries(self, generators_only=True) -> np.ndarray:
        ...
        if len(sources_with_copies):
            ...
            for source in tqdm(sources_with_copies,
                ...
                if generators_only and inf_level > 2:
                    ...
                    permutations_plus = increase_values_by_one_and_prepend_with_column_of_zeros(list(
                ...
                if generators_only and inf_level > 2:
                    one_source_symmetries = group_elements_from_group_generators(one_source_symmetries)
