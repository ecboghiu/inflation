...
def solveSDP_MosekFUSION_old(mask_matrices,
                         objective={'1': 0.},
                         known_vars={'0': 0., '1': 1.},
                         semiknown_vars={},
                         positive_vars=[],
    ...
    import pickle
    with open('BadFruits.obj', 'wb') as fp:
        pickle.dump([F0, Fi, known_vars, semiknown_vars, var_equalities, var_inequalities], fp)
